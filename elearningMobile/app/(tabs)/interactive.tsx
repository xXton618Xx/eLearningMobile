...
export default function InteractiveIndex() {
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedText type="title">Interactive</ThemedText>
      <View style={styles.grid}>
        <TouchableOpacity style={[styles.card, { backgroundColor: cardBg }]}> 
          <Link href="/../interactive/matching" asChild>
            <ThemedText type="defaultSemiBold">Matching (5–10 pairs)</ThemedText>
          </Link>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.card, { backgroundColor: cardBg }]}> 
          <Link href="/../interactive/fill" asChild>
            <ThemedText type="defaultSemiBold">Fill-in-the-blanks</ThemedText>
          </Link>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.card, { backgroundColor: cardBg }]}> 
